<style>
    ...
    #contents2.section1 { font-size:1000px; }
...
<sl-button href="#overview" target="_blank" size=medium pill>Lesson 2.1 Overview</sl-button>
    <sl-button href="#goals" target="_blank" size=medium pill>Goals</sl-button>
    <sl-button href="#agenda" target="_blank" size=medium pill>Agenda</sl-button>
    <sl-button href="#readings" target="_blank" size=medium pill>Readings</sl-button>
    <sl-button href="#plan" target="_blank" size=medium pill>Lesson Plan</sl-button>
    <sl-button href="#discussion" target="_blank" size=medium pill>Discussion</sl-button>
    <sl-button href="#activity1" target="_blank" size=medium pill>Activity 1: HOLC Redlining Maps</sl-button>
    <sl-button href="#activity2" target="_blank" size=medium pill>Activity 2: Data Biography of HOLC Redlining Maps</sl-button>
