...
<sl-button href="#overview" target="_blank" variant="default" size="large" style={{ width: '100%' }}>Lesson 2.1 Overview</sl-button><br>
    <sl-button href="#goals" target="_blank" size=large pill>Goals</sl-button>
    <sl-button href="#agenda" target="_blank" size=large pill>Agenda</sl-button>
    <sl-button href="#readings" target="_blank" size=large pill>Readings</sl-button>
    <sl-button href="#plan" target="_blank" size=large pill>Lesson Plan</sl-button>
    <sl-button href="#discussion" target="_blank" size=large pill>Discussion</sl-button>
    <sl-button href="#activity1" target="_blank" size=large pill>Activity 1: HOLC Redlining Maps</sl-button>
    <sl-button href="#activity2" target="_blank" size=large pill>Activity 2: Data Biography of HOLC Redlining Maps</sl-button>
    <sl-button href="/module-2/" target="_blank" size=large pill>Return to Module 2</sl-button>
