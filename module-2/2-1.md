...
# Contents Version II {#contents}

<sl-button href="#overview" target="_blank" size=medium pill>Lesson 2.1 Overview</sl-button><br><br>
<sl-button href="#goals" target="_blank" size=medium pill>Goals</sl-button><br><br>
<sl-button href="#agenda" target="_blank" size=medium pill>Agenda</sl-button><br><br>
<sl-button href="#readings" target="_blank" size=medium pill>Readings</sl-button><br>
<sl-button href="#plan" target="_blank" size=medium pill>Lesson Plan</sl-button><sl-button href="#discussion" target="_blank" size=medium pill>Discussion</sl-button><sl-button href="#activity1" target="_blank" size=medium pill>Activity 1: HOLC Redlining Maps</sl-button><sl-button href="#activity2" target="_blank" size=medium pill>Activity 2: Data Biography of HOLC Redlining Maps</sl-button><br><br>
<sl-button href="/module-2/" target="_blank" size=medium pill>Return to Module 2</sl-button>
