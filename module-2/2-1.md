...
<sl-button href="#overview" target="_blank" size=medium pill>Lesson 2.1 Overview</sl-button><br>
<sl-button href="#goals" target="_blank" size=medium pill>Goals</sl-button><br>
<sl-button href="#agenda" target="_blank" size=medium pill>Agenda</sl-button><br>
<sl-button href="#readings" target="_blank" size=medium pill>Readings</sl-button>
