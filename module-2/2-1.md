...
# Contents {#contents}
— [Lesson 2.1 Overview](#overview) <br>
— [Goals](#goals) <br>
— [Agenda](#agenda) <br>
— [Readings](#readings) <br>
— [Lesson Plan](#plan) <br>
> [Discussion](#discussion) <br>
> [Activity 1: HOLC Redlining Maps](#activity1) <br>
> [Activity 2: Data Biography of HOLC Redlining Maps](#activity2) <br>

# Contents Version II {#contents2}

<sl-button href="#overview" target="_blank" variant="default" size="large">Lesson 2.1 Overview</sl-button><br>
<sl-button href="#goals" target="_blank" variant="default" size="large">Goals</sl-button>
    <sl-button href="#agenda" target="_blank" variant="default" size="large">Agenda</sl-button>
    <sl-button href="#readings" target="_blank" variant="default" size="large">Readings</sl-button>
    <sl-button href="#plan" target="_blank" variant="default" size="large">Lesson Plan</sl-button>
    <sl-button href="#discussion" target="_blank" variant="default" size="large">Discussion</sl-button>
    <sl-button href="#activity1" target="_blank" variant="default" size="large">Activity 1: HOLC Redlining Maps</sl-button>
    <sl-button href="#activity2" target="_blank" variant="default" size="large">Activity 2: Data Biography of HOLC Redlining Maps</sl-button>
    <sl-button href="/module-2/" target="_blank" variant="default" size="large">Return to Module 2</sl-button>
