...
<p align=center>
    <sl-button href="/module-2/" variant="neutral" size="large">Return to Module Overview</sl-button>
    <sl-button href="/2-2/" variant="neutral" size="large">Next Lesson: 2.2: Slavery and Data</sl-button>
</p>

# Contents {#contents}
— [Lesson Overview](#overview) <br>
— [Goals](#goals) <br>
— [Readings](#readings) <br>
— [Agenda](#agenda) <br>
— [Discussion: Catherine D'Ignazio and Lauren Klein, "Collect, Analyze, Imagine, Teach"](#discussion) <br>
...
<p align=center>
    ...
    <sl-button href="#discussion" variant="neutral" size="large">Catherine D'Ignazio and Lauren Klein, "Collect, Analyze, Imagine, Teach"</sl-button>
