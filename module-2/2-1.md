...
> This reading introduces students to some larger concepts related to data feminism, including "from data ethics to data justice"

## Activities

### HOLC Redlining Maps

>In this activity, students use an interactive map interface to explore a particular city (take the nearest city they might be familiar with, if any). This map interface, *Mapping Inequality*, has scanned, georeferenced, and overlaid HOLC maps from the 1930s onto modern cities (maps which were referenced in *Data Feminism* reading for this module. This allows students to zoom into different nieighborhood and explore how this federal agency overlaid conceptions of race, class, and ethnicity onto their grading system for mortgage lending.
